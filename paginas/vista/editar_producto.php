                                ...
                                <form id="frm_editar_prod.php" name="frm_editar_prod" method="post" action="../controlador/ctr_grabar_prod.php" autocomplete="off">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="txt_gnc" name="txt_gnc" placeholder="Ganancia" min="1" max="100" step="0.01" value="<?= $rs_prod->ganancia * 100 ?>" />
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select form-select-lg mb-3" name="cbo_mar" id="cbo_mar">
                                                ...
                                                <?php foreach ($rs_mar as $mar) { ?>
                                                    <option value="<?= $mar->codigo_marca ?>" <?= ($mar->codigo_marca == $rs_prod->producto_codigo_marca) ? 'selected' : '' ?>>
                                                        <?= $mar->marca ?>
                                                    </option>
                                                <?php } ?>
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select form-select-lg mb-3" name="cbo_cat" id="cbo_cat">
                                                ...
                                                <?php foreach ($rs_cat as $cat) { ?>
                                                    <option value="<?= $cat->codigo_categoria ?>" <?= ($cat->codigo_categoria == $rs_prod->producto_codigo_categoria) ? 'selected' : '' ?>>
                                                        <?= $cat->categoria ?>
                                                    </option>
                                                <?php } ?>
                                            </select>
